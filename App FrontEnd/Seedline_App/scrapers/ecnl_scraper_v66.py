...
"""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
ECNL COMPREHENSIVE SCRAPER v65 - ADMIN UI COMPATIBLE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def save_team(db_path: str, team: Dict) -> bool:
    ...
    if cur.fetchone():
        conn.close()
        return False
    cur.execute("""INSERT INTO teams (team_url, club_name, team_name, age_group, gender, league, conference, event_id, scraped_at)
                  VALUES (?,?,?,?,?,?,?,?,datetime('now'))""",
...
async def main_async():
    ...
    print("\n" + "="*60)
    print("🏃 ECNL COMPREHENSIVE SCRAPER v65")
    print("="*60)
    print(f"📂 Database: {db}")
