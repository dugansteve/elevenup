#!/usr/bin/env python3
"""
US Club Soccer NPL League Scraper v16.0
=======================================
...
TEAMS_CSV_COLUMNS = [
    ...
    'schedule_url', 'profile_url', 'discovered_at',
]
...
def interactive_menu() -> Dict:
    ...
    print("\n" + "=" * 70)
    print("🏆 US CLUB SOCCER NPL SCRAPER v12.0")
    print("=" * 70)
...
class USClubNPLScraper:
    ...
    async def run(self, tier: str = None, region: str = None,
        ...
        self.logger.header("🚀 US CLUB SOCCER NPL SCRAPER v12.0")
                ...
                try:
                    ...
                    while current_league_index < len(leagues):
                        ...
                        if league.platform == 'gotsport':
                            ...
                            self.total_stats['games_found'] += len(games)
                            self.total_stats['teams_found'] += len(teams)
...
def main():
    parser = argparse.ArgumentParser(
        description='US Club Soccer NPL Scraper v5.0',
