...
"""
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SOCCER TEAM RANKING SYSTEM - V40 (MINIMUM WINS RULE)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
USAGE:
  python team_ranker_v40.py                        # Interactive mode
  python team_ranker_v40.py --cleanup              # Force cleanup first  
  python team_ranker_v40.py --no-cleanup           # Skip cleanup
  python team_ranker_v40.py --dry-run              # Preview cleanup only
  python team_ranker_v40.py --verbose              # Extra diagnostics
...
class TeamRankerV30:
    ...
    def save_outputs(self, all_rankings):
        ...
        try:
            ...
            excel_path = Path(f'All_Age_Groups_Rankings_V40_{timestamp}.xlsx')
